package cc.fastcv.basic_general.activity
...
open class BaseActivity : AppCompatActivity() {
    ...
    /**
     * return: [View.LAYOUT_DIRECTION_LTR] or [View.LAYOUT_DIRECTION_RTL]
     */
    open fun getLayoutDirection() : Int {
        return findViewById<View>(android.R.id.content).layoutDirection
    }
