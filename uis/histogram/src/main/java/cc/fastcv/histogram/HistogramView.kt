...
class HistogramView : View {
     ...
     * 柱状图颜色
     */
    private var histogramColor = Color.parseColor("#026543")

    /**
     * 柱状图颜色
     */
    private var histogramSelectColor = Color.parseColor("#A3B352")
    ...
    private fun calc() {
        ...
        for (i in 0 until data.size) {
            ...
            if (lastSelectIndex == -1) {
                lastSelectIndex = i
                callback?.onHistogramSelect(lastSelectIndex,histogramInfo)
            }
        }
