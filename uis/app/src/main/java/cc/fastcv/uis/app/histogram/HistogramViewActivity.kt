package cc.fastcv.uis.app.histogram
...
import cc.fastcv.histogram.HistogramExtView
import cc.fastcv.uis.app.R

class HistogramViewActivity : AppCompatActivity() {

    private lateinit var histogram: HistogramExtView
