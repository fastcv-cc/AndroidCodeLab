...
class DateSwitchVH(itemView: View) : RecyclerView.ViewHolder(itemView) {
    ...
    fun updateTextByState(
        ...
        if (isInvalid) {
            textView.setTextColor(Color.parseColor("#99003324"))
            textView.background = null
            return textView
        }

        textView.setTextColor(Color.parseColor("#003324"))
        textView.background = null
        return textView
    }
