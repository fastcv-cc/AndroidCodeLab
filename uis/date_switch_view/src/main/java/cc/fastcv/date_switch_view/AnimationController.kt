...
class AnimationController(
    private val dateSwitchView: DateSwitchView,
    private val tabSwitchViewController: TabSwitchViewController,
    private val dateSelectController: DateSelectController
) {
